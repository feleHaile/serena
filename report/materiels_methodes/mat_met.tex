...
La conversion des données RapidEye en réflectance TOA s'effectue en 2 étapes :
...
opérationnelle en matière d'observation de la Terre notamment pour la surveillance de l'environnement et la sécurité. La mission Sentinel-2 est la composante spatiale du programme 
...
180° sur la même orbite héliosynchrone de 10h30. Ces 2 satellites sont identiques et embarquent l'instrument \acrshort{msi} qui fournit des images dans 13 bandes spectrales 
du Visible à l'Infrarouge (\Cref{msi}) avec une résolution spatiale comprise entre 10 et 60 mètres et une résolution radiométrique de 12 bits. En configuration opérationnelle, les satellites Sentinel-2 permettront d'avoir une période
de revisite au nadir de 5 jours et au moins une donnée claire par mois sur la plupart des terres émergées. Cette grande richesse spectrale couplée à cette capacité d'observation temporelle 
...
\label{msi}
 \begin{tabular}{cccc}
  \hline
  Bande spectrale & Domaine spectral & Longueurs d'onde (um) & R. spatiale (m)\\
  \hline
...
météorologiques n'ont pas été considérées.
