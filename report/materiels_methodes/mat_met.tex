...
\end{itemize}
La \Cref{terrain} présente les principales statistiques descriptives pour les parcelles suivies où nous pouvons nous apercevoir de \ldots{} comme espéré. La \ldots{} la localisation des parcelles suivant leurs cultures et système de culture ainsi que la biomasse fraîche et les rendements frais observés.
...
\`A présent, nous disposons  d'une série temporelle pour chaque indice de végétation calculé. Cependant, avant de pouvoir les exploiter pour la suite de notre travail, un autre 
