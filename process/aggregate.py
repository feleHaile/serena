...
def aggregate (inFile, inVectorFile, outCSV_original, outCSV_smoothing) :
    """
...
if __name__=="__main__":
    ...
    inFile = "/home/je/Bureau/Stage/Output/INDICES/NDVI/NDVI_Planet_RapidEye.nc"
...
#    inVectorFile = "H:/Gbodjo_2018/Data/Terrain/SimCo_2017_CLEAN_JOIN_COR_SOPHIE_ADAMA_32628_JOIN.shp"
    outCSV_original = "/home/je/Bureau/Stage/Output/INDICES/NDVI/Mean_NDVI_original_PlanetRapidEye.csv"
    outCSV_smoothing = "/home/je/Bureau/Stage/Output/INDICES/NDVI/Mean_NDVI_hants_PlanetRapidEye.csv"
    aggregate (inFile, inVectorFile, outCSV_original, outCSV_smoothing)
